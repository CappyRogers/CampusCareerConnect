...
<html>
<head>
    <title>Undergraduate data</title>
    ...
    <style>
       ...
       .header {
 background-image: linear-gradient(to right, #35ab9b, #1cc8a7, #10d7ab, #05bfdb);
  padding: 5px;
  display: flex;
  align-items: center;
  margin-top: 0;
...
<body>
<div class="header"style="border-bottom:2px SOLID #fff;">
    ...
    <div class="title" style="color:ghostwhite; ">Graduation year : <?php $dbname = $_POST['db']; echo substr($dbname,3);?></div>
</div>
<div class="container">
<div class="box">
<?php
