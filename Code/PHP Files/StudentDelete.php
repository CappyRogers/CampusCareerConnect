...
<body>
	...
	<div id="tablecontainer">
		...
		//error_reporting(0);
			...
			echo "<tr><th>CIN</th><th>Name</th><th>Email</th><th>CGPA</th><th></th></tr>";
			while($row=mysqli_fetch_assoc($res))
			{
			  ...
			  $email=$row['Email'];
			  $cgpa=$row['CGPA'];
			  echo "<tr><td>$cin</td><td>$name</td><td>$email</td><td>$cgpa</td><td class='deletebutton'><button name='delete' class='btn' type='button' onclick=\"openpopup('" . $cin . "')\">DELETE</button></td></tr>";
			}
			$conn->close();
		?>
